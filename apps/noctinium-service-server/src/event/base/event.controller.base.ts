...
import { SocialMediaPostFindManyArgs } from "../../socialMediaPost/base/SocialMediaPostFindManyArgs";
import { SocialMediaPost } from "../../socialMediaPost/base/SocialMediaPost";
import { SocialMediaPostWhereUniqueInput } from "../../socialMediaPost/base/SocialMediaPostWhereUniqueInput";
...
export class EventControllerBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @common.Get("/:id/socialMediaPosts")
  ...
  async findSocialMediaPosts(
    @common.Req() request: Request,
    @common.Param() params: EventWhereUniqueInput
  ): Promise<SocialMediaPost[]> {
    const query = plainToClass(SocialMediaPostFindManyArgs, request.query);
    const results = await this.service.findSocialMediaPosts(params.id, {
      ...query,
      select: {
        content: true,
        createdAt: true,
  ...
  @common.Post("/:id/socialMediaPosts")
  @nestAccessControl.UseRoles({
    resource: "Event",
    action: "update",
    possession: "any",
  })
  async connectSocialMediaPosts(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: SocialMediaPostWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      socialMediaPosts: {
        connect: body,
  ...
  @common.Patch("/:id/socialMediaPosts")
  @nestAccessControl.UseRoles({
    resource: "Event",
    action: "update",
    possession: "any",
  ...
  @common.Delete("/:id/socialMediaPosts")
  @nestAccessControl.UseRoles({
    resource: "Event",
    action: "update",
    possession: "any",
  })
  async disconnectSocialMediaPosts(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: SocialMediaPostWhereUniqueInput[]
  ): Promise<void> {
    const data = {
